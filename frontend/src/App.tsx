...
const I18N: Record<AppLanguage, Record<string, string>> = {
  ...
  he: {
    ...
    profileSelectTitle: 'כניסה לפי רשימת משתתפים פעילים',
    selectPlayer: 'בחר משתתף',
    playerPasswordPlaceholder: 'סיסמה (אם קיימת)',
    playerLogin: 'אישור כניסה',
    adminLoginTitle: 'כניסת מנהל',
    adminUsernamePlaceholder: 'שם משתמש מנהל',
    adminPasswordPlaceholder: 'סיסמת מנהל',
    adminLoginButton: 'כניסה כמנהל',
    ...
    welcomeBullet1: 'יצירה וניהול של קבוצות עם משתתפים קבועים.',
    ...
    registrationGuideStep2: 'בחרו תפקיד: מנהל או משתתף.',
    registrationGuideStep3: 'מנהל יוצר קבוצה חדשה, משתתף מצטרף לקבוצה קיימת.',
    ...
    createGroupHint: 'מנהל יוצר קבוצה חדשה. משתתף מצטרף לקבוצה קיימת.',
    noGroupsYet: 'אין קבוצות עדיין. קודם צריך ליצור קבוצה כמנהל.',
    groupTabTitle: 'קבוצות',
    gameTypeTabTitle: 'סוגי אירוע',
    adminAsPlayer: 'כניסה כמשתתף',
    adminSetupTitle: 'הגדרות אירוע למנהל',
